...
public class CenaQuatro {
    ...
    public static void cartaChefe() {
        Utils.escrever("'Olá {Nome}, Como vai?\n" 
    ...
    public static void cartaAnuncio() {
        Utils.escrever("'Olá caro(a), {Nome},\n" 
    ...
    public static void aceitarOportunidade2() {
        Utils.escrever("Enviei uma carta para o Sr.George agradecendo toda sua consideração e dizendo que eu recusaria a proposta, e disse que não poderia ir, pois estava sentindo que algo maior estava por acontecer...\n"
