...
public class CenaTres {
    ...
    public static void comprarJornal() {
        Utils.escrever(
    ...
    public static void testeCruzadinha() {
        Utils.escrever(
    ...
    public static void ligacaoTeste() {
        Utils.escrever(
    ...
    public static void naoLigarParaNumero() {
        Utils.escrever(
    ...
    public static void sairComPressa() {
        Utils.escrever(
