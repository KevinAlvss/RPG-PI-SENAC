...
public class CenaSete {
    ...
    private static void perguntarOqueEstaAcontecendo() {
        Utils.escrever("Ao ver o comandante lá eu descido questioná-lo sobre oque  está acontecendo... e então ele me diz , ontem o pessoal da inteligencia interceptou uma mensagem saída daqui que foi direcionada direto a Moscou, e acreditamos fortemente que o colega de vocês Alan Turing seja um espião um soviético");
        naoDizerNada();
    }

    private static void naoDizerNada() {
        Utils.escrever(" ele entra  começa a revirar as coisas de Alan, quando Alan chega ele questiona o oque esta acontecendo e o comandante lhe diz que ele está em busca de provas que Alan é um agente soviético porem não encontra nada relevante, apos isso com o clima meio pesado nos começamos a trabalhar....");
        Utils.escrever("*Dois dias depois *\nApos horas e mais horas , dias e mais dias , eu ja vou ficando sem esperança de fazermos algum avanço... como estou de cebeça cheia, então deicido dar um volta pela sala, e olho para mesa de Alan e vejo alguns papeis encima da mesa."); 
    ...
    private static void decidoIrOlhar(){
        Utils.escrever("Vou ate a mesa de Alan e olhos os papeis dele, eram da maquina de turing ");
    ...
    private static void naoIrComOsRapazes() {
        ...
        Utils.escrever("John diz “Sera que devemos ir olhar ?”, então respondo não, acho que deve ser apenas o Alan mexendo na maquina... escutamos mais batidas e gritaria, e hugh diz “Pessoal acho melhor irmos lá ver oque está acontecendo...”,hugh e os rapazes foram em direção ao galpão");
    ...
    private static void naoIrComOsRapazesDois() {
        ...
        System.out.print("\nEu permaneço sentado em minha cadeira,Peter pergunta “ue," + Jogador.GetNomeJogador() + " você não vai?”");
    ...
    private static void naoIrDois(){
        ...
        Utils.escrever("Um tempo mais tarde eles voltam e me dizem oque aconteceu, e me falam oque havia acontece , que o comandante disse que a maquina de alan era inutil , mas devido a resistência deles o comandante nos deu 1 mês para finalizar a maquina");
        ...
        while (saiu) {
            ...
            switch (decisao) {
                ...
                case "2":
                        Utils.escrever("então eu digo “Certo,conte comigo... nos vamos terminar essa maquina e fazer ela funcionar !!!”");
                        apoiarHugh();
                        saiu = true;
                    break;    
                default:
    ...
    private static void irComOsRapazes() {
        ...
        Utils.escrever("Me levanto eu vou com o pessoal, chegando lá, nos encontramos uns soldados segurando Alan e o comandante   falando que Alan está demitido por sua maquina ser inútil, então hugh diz “ se ele está demitido ...então eu estou fora” e todos o acompanham dizendo a mesma coisa");
